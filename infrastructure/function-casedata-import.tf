module "function_casedata_import" {
  ...
  source = "github.com/Planning-Inspectorate/infrastructure-modules.git//modules/node-function-app?ref=1.55"
  ...
  app_settings = {
    ...
    AzureFunctionsJobHost__serviceBus__maxConcurrentCalls = "3"
