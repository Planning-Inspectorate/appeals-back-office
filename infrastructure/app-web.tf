module "app_web" {
  ...
  app_settings = {
    ...
    FEATURE_FLAG_LDC_HEARING                = var.apps_config.featureFlags.featureFlagLdcHearing
    FEATURE_FLAG_LDC_INQUIRY                = var.apps_config.featureFlags.featureFlagLdcInquiry
    FEATURE_FLAG_ELB_HEARING                = var.apps_config.featureFlags.featureFlagElbHearing
    FEATURE_FLAG_ELB_INQUIRY                = var.apps_config.featureFlags.featureFlagElbInquiry
