...
resource "azurerm_virtual_network_peering" "stage_to_test_environment" {
  ...
  remote_virtual_network_id = data.azurerm_virtual_network.vnet_primary_test.id #test env vnet data source
  resource_group_name       = azurerm_virtual_network.main.resource_group_name
...
resource "azurerm_virtual_network_peering" "test_environment_to_stage" {
  ...
  virtual_network_name      = var.service_bus_staging.network_name # test env vnet data source
}
