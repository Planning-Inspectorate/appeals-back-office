import { formatYesNoDetails } from '../../../lib/nunjucks-filters/index.js';
...
export function mapSiteAccessSection(templateData) {
	const { siteAccessRequired, reasonForNeighbourVisits, healthAndSafety } =
