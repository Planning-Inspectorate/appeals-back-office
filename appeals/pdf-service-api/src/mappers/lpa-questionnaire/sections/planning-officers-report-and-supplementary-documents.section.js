...
export function mapPlanningOfficersReportAndSupplementaryDocumentsSection(templateData) {
	const {
	...
	return {
		...
		items: [
			...
			},
			{
				...
				text: formatDate(infrastructureLevyAdoptedDate, 'd MMMM yyyy')
			},
			{
				key: 'When do you expect to formally adopt the community infrastructure levy?',
				text: formatDate(infrastructureLevyExpectedDate, 'd MMMM yyyy')
			},
			{
