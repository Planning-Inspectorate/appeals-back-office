...
router.delete(
	...
	/*
        #swagger.tags = ['Appeal Rule 6 Parties']
        #swagger.path = '/appeals/{appealId}/rule-6-parties/{rule6PartyId}'
        #swagger.description = 'Deletes a rule 6 party for an appeal'
        #swagger.parameters['azureAdUserId'] = {
            in: 'header',
            required: true,
            example: '434bff4e-8191-4ce0-9a0a-91e5d6cdd882'
        ...
        #swagger.responses[200] = {
            description: 'Deletes a rule 6 party for an appeal',
            schema: { $ref: '#/components/schemas/Rule6PartyResponse' }
        }
        #swagger.responses[400] = {}
        #swagger.responses[404] = {}
	 */
	validators.deleteRule6PartyValidator,
	checkAppealExistsByIdAndAddPartialToRequest(['appealRule6Parties']),
	asyncHandler(controller.deleteRule6Party)
);
