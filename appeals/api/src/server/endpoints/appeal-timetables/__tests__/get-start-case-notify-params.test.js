...
describe('getStartCaseNotifyParams Unit Tests', () => {
	...
	describe('Recipient Email Filtering', () => {
		test.each([
			[
				'agent email taking precedence when both agent and appellant emails exist',
				{
					appellant: { email: 'appellant@test.com' },
			...
			[
				'appellant only when LPA and agent emails are missing',
				{ appellant: { email: 'appellant@test.com' }, agent: null, lpa: { email: null } },
