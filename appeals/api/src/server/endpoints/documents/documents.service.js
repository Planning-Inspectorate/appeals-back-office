	...
	switch (stage) {
		case APPEAL_CASE_STAGE.APPELLANT_CASE:
			folders = [
				...
				`${APPEAL_CASE_STAGE.APPELLANT_CASE}/${ENFORCEMENT_NOTICE_APPEAL_DOCUMENT_TYPE.PRIOR_CORRESPONDENCE_WITH_PINS}`,
				`${APPEAL_CASE_STAGE.APPELLANT_CASE}/${ENFORCEMENT_NOTICE_APPEAL_DOCUMENT_TYPE.ENFORCEMENT_NOTICE}`,
				`${APPEAL_CASE_STAGE.APPELLANT_CASE}/${ENFORCEMENT_NOTICE_APPEAL_DOCUMENT_TYPE.ENFORCEMENT_NOTICE_PLAN}`,
		...
		case APPEAL_CASE_STAGE.COSTS:
			...
			break;
		case APPEAL_CASE_STAGE.STATEMENTS:
			folders = [
				`${APPEAL_CASE_STAGE.STATEMENTS}/${APPEAL_DOCUMENT_TYPE.RULE_6_STATEMENT}`,
				`${APPEAL_CASE_STAGE.STATEMENTS}/${APPEAL_DOCUMENT_TYPE.RULE_6_PROOF_OF_EVIDENCE}`,
				`${APPEAL_CASE_STAGE.STATEMENTS}/${APPEAL_DOCUMENT_TYPE.RULE_6_WITNESSES_EVIDENCE}`
