...
export const getRootFoldersForAppeal = async (appealId) => {
	// TODO: LPAQ_QUESTIONNAIRE.ENVIRONMENTAL_ASSESSMENT needs to be added to "pins-data-model"
	return await getByCaseIdAndPaths(appealId, [
		...
		// `${APPEAL_CASE_STAGE.APPELLANT_CASE}/${LPAQ_QUESTIONNAIRE.ENVIRONMENTAL_ASSESSMENT}`,
