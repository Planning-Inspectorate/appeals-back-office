...
/**
 * @param {import('@pins/appeals-database/src/client/models.ts').DocumentCreateManyInput[]} documentData
 */
export const createDocuments = async (documentData) =>
	databaseConnector.document.createMany({ data: documentData });

/**
 * @param {import('@pins/appeals-database/src/client/models.ts').DocumentVersionCreateManyInput[]} versionData
 */
export const createDocumentVersions = async (versionData) =>
	databaseConnector.documentVersion.createMany({ data: versionData });

/**
 * @param {import('@pins/appeals-database/src/client/models.ts').RepresentationAttachmentCreateManyInput[]} attachmentData
 */
