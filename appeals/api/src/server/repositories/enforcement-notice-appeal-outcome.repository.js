...
/**
 * @param {import('@pins/appeals-database/src/client/client.ts').Prisma.EnforcementNoticeAppealOutcomeWhereUniqueInput} where
 * @param {import('@pins/appeals-database/src/client/client.ts').Prisma.EnforcementNoticeAppealOutcomeCreateInput} data
