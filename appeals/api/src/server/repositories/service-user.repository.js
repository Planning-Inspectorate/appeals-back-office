...
/** @typedef {import('@pins/appeals-database/src/client/models.ts').ServiceUserUncheckedCreateInput} ServiceUserCreateInput */
 ...
 * @param { number } id
 * @param {import('@pins/appeals-database/src/client/models.ts').ServiceUserUncheckedUpdateInput} data
 * @returns {Promise<ServiceUser | null>}
 */
