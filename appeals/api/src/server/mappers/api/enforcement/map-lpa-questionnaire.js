	...
	if (lpaQuestionnaire) {
		return {
			...
			siteAreaSquareMetres: lpaQuestionnaire.siteAreaSquareMetres
				...
				: null,
			areaOfAllegedBreachInSquareMetres: lpaQuestionnaire?.areaOfAllegedBreachInSquareMetres ? Number(lpaQuestionnaire.areaOfAllegedBreachInSquareMetres) : null,
			floorSpaceCreatedByBreachInSquareMetres: lpaQuestionnaire?.floorSpaceCreatedByBreachInSquareMetres ? Number(lpaQuestionnaire.floorSpaceCreatedByBreachInSquareMetres) : null,
