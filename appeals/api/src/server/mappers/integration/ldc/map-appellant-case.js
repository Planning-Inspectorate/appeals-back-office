...
export const mapAppellantCase = (data) => {
	...
	return {
		...
		applicationMadeUnderActSection: casedata?.applicationMadeUnderActSection ?? null,
		siteUseAtTimeOfApplication: casedata?.siteUseAtTimeOfApplication ?? null,
		// required fields, but not used in ldc
