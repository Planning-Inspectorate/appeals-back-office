...
const { value, error } = schema.validate({
	...
	serviceBusOptions: {
		...
		topicAppealEventEstimate: environment.SB_TOPIC_NAME_APPEAL_EVENT_ESTIMATE || 'appeal-event-estimate',
		topicDocumentMove: environment.SB_TOPIC_NAME_DOCUMENT_MOVE || 'appeal-document-to-move',
		topicAppealRepresentation: environment.SB_TOPIC_NAME_APPEAL_REPRESENTATION || 'appeal-representation'
	},
	msal: {
