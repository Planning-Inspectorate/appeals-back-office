...
export default {
	...
	appellantCase: {
		...
		caseSubmissionDueDate: new Date('2024-11-27T15:08:53.894Z'),
	...
	lpaQuestionnaire: {
		id: 2,
		appealId: 2,
		lpaQuestionnaireValidationOutcomeId: new Date('2023-05-08T23:00:00.000Z'),
		...
		lpaAppealInvalidReasons: 'reasons',
		hasInfrastructureLevy: true,
		isInfrastructureLevyFormallyAdopted: new Date('2023-05-08T23:00:00.000Z'),
		infrastructureLevyAdoptedDate: new Date('2023-05-08T23:00:00.000Z'),
		infrastructureLevyExpectedDate: new Date('2023-05-08T23:00:00.000Z'),
		siteAccessDetails: 'There is a tall hedge around the site which obstructs the view of the site',
		reasonForNeighbourVisits: 'test',
