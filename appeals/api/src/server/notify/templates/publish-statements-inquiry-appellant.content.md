...
{% elif has_lpa_statement and has_rule_6_statement and has_ip_comments -%}
   We have received:
   - all statements
   - comments from interested parties
{% elif not has_lpa_statement and has_rule_6_statement -%}
   We have received a statement from a Rule 6 party.
{% elif has_lpa_statement and has_ip_comments and not has_rule_6_parties  -%}
   We have received the local planning authority's questionnaire, all statements and comments from interested parties.
{% elif has_lpa_statement and has_ip_comments and has_rule_6_parties and not has_rule_6_statement -%}
   We have received the local planning authority's questionnaire, statement and any comments from interested parties.
...
{% if (has_ip_comments or has_rule_6_statement) and not has_lpa_statement -%}
   The local planning authority did not submit a statement.
{% endif -%}
{% if (has_lpa_statement or has_rule_6_statement) and not has_ip_comments and not has_rule_6_parties -%}
...
You need to [submit your proof of evidence and witnesses]({{front_office_url}}/appeals/{{appeal_reference_number}}) by {{proof_of_evidence_due_date}}.
