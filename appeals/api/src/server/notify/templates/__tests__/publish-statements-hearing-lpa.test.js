...
describe('publish-statements-hearing-lpa.md', () => {
	...
	test('should render correctly when both lpa statement and ip comments received with hearing date', async () => {
		...
		const expectedContent = [
			...
			'# What happens next',
			'',
			'The hearing is on 15 March 2025.',
			'',
	...
	test('should render correctly when only ip comments received with hearing date', async () => {
		const notifySendData = {
			doNotMockNotifySend: true,
			templateName: 'publish-statements-hearing-lpa',
			notifyClient,
	...
	test('should render correctly when no ip comments received', async () => {
		const notifySendData = {
			doNotMockNotifySend: true,
			templateName: 'publish-statements-hearing-lpa',
			notifyClient,
