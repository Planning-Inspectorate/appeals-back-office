...
describe('appeal-valid-start-case-ldc-appellant.md', () => {
	test('should call notify sendEmail with the correct data', async () => {
		const notifySendData = {
			doNotMockNotifySend: true,
			templateName: 'appeal-valid-start-case-ldc-appellant',
			notifyClient: {
				sendEmail: jest.fn()
			},
		...
		const expectedContent = [
			...
			'# What happens next',
			'',
			'You need to [submit your statement](/mock-front-office-url) by 01 March 2025.',
			'',
