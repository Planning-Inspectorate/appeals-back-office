...
describe('publish-statements-written-reps-lpa.md', () => {
	...
	test('should render correctly when both appellant statement and ip comments received', async () => {
		...
		const expectedContent = [
			...
			'# What happens next',
			'',
			'You need to [submit your final comments](/mock-front-office-url/manage-appeals/ABC45678) by 1 January 2025.',
			'',
	...
	test('should render correctly when only appellant statement received', async () => {
		const notifySendData = {
			doNotMockNotifySend: true,
			templateName: 'publish-statements-written-reps-lpa',
			notifyClient,
	...
	test('should render correctly when neither appellant statement nor ip comments received', async () => {
		const notifySendData = {
			doNotMockNotifySend: true,
			templateName: 'publish-statements-written-reps-lpa',
			notifyClient,
