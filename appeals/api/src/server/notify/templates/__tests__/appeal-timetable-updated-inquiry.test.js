...
describe('appeal-timetable-updated-inquiry.content.md', () => {
	test('should render correct content with all optional dates', async () => {
		const notifySendData = {
			doNotMockNotifySend: true,
			templateName: 'appeal-timetable-updated-inquiry',
			notifyClient: {
				sendEmail: jest.fn()
			},
			...
			personalisation: {
				...
				statement_of_common_ground_due_date: '24 January 2025',
				proof_of_evidence_and_witnesses_due_date: '26 January 2025',
				planning_obligation_due_date: '23 January 2025',
				case_management_conference_due_date: '27 January 2025',
