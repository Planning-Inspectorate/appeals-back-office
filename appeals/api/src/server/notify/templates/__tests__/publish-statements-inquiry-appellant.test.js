...
describe('publish-statements-inquiry-appellant.md', () => {
	...
	test('should render correctly when all received (lpa statement, rule 6 statement and ip comments)', async () => {
		...
		const expectedContent = [
			...
			'# What happens next',
			'',
			'You need to [submit your proof of evidence and witnesses](/mock-front-office-url/appeals/ABC45678) by 20 October 2025.',
			'',
	...
	test('should render correctly when lpa statement and ip comments received without rule 6 parties', async () => {
		const notifySendData = {
			doNotMockNotifySend: true,
			templateName: 'publish-statements-inquiry-appellant',
			notifyClient,
	...
	test('should render correctly when lpa statement and ip comments received with rule 6 parties but no rule 6 statement', async () => {
		const notifySendData = {
			doNotMockNotifySend: true,
			templateName: 'publish-statements-inquiry-appellant',
			notifyClient,
