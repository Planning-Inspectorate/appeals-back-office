...
describe('enforcement-notice-incomplete-appellant.md', () => {
	test('should call notify sendEmail with all reasons selected', async () => {
		...
		const expectedContent = [
			...
			'# What happens next',
			'',
			'We have asked the local planning authority for comments. If you also want to add comments, contact caseofficers@planninginspectorate.gov.uk by 14 July 2035.',
			'',
