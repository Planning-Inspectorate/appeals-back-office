...
describe('appeal-valid-start-case-cas-advertisement-inquiry.content.md', () => {
	test('should call notify sendEmail with the correct data when is LPA', async () => {
		...
		const expectedContent = [
			...
			'# What happens next',
			'',
			'Email a copy of your appeal statement to caseofficers@planninginspectorate.gov.uk by 01 January 2025. You will be able to view this in your appeal details.',
			'',
