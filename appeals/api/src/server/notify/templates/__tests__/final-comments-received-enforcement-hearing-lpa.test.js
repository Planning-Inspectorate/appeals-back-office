...
describe('final-comments-received-enforcement-hearing-lpa.md', () => {
	test('should call notify sendEmail with the correct data - hearing date set', async () => {
		const notifySendData = {
			doNotMockNotifySend: true,
			templateName: 'final-comments-received-enforcement-hearing-lpa',
			notifyClient: {
				sendEmail: jest.fn()
			},
		...
		const expectedContent = [
			...
			'',
			'You can [view this information in the appeal service](/mock-front-office-url/manage-appeals/ABC45678).',
			'',
			'# Appeal details',
			'',
