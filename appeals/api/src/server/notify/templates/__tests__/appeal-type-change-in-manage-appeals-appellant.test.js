...
describe('appeal-type-change-in-manage-appeals-appellant.md', () => {
	test('should call notify sendEmail with the correct data', async () => {
		...
		const expectedContent = [
			...
			'',
			'We have changed your householder appeal to planning appeal. We have removed any documents you submitted that are not included with a planning appeal.',
			'',
			'# What happens next',
			'',
			'We will contact you:',
		...
		expect(notifySendData.notifyClient.sendEmail).toHaveBeenCalledWith(
			...
			'test@136s7.com',
			{
				...
				subject: 'We have changed your appeal: 134526'
			}
		);
	});
});
