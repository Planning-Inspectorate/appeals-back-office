...
describe('enforcement-notice-incomplete-lpa.md', () => {
	test('should call notify sendEmail with all reasons selected', async () => {
		...
		const expectedContent = [
			'We have reviewed the enforcement notice and it may not be valid.',
			'',
			'# Appeal details',
			'',
			...
			'# What happens next',
			'',
			'Contact caseofficers@planninginspectorate.gov.uk with your comments or to confirm if you will withdraw this enforcement notice and serve another by 14 July 2035.',
			'',
