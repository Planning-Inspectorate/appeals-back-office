...
describe('appeal-confirmed-enforcement-appellant.md', () => {
	...
	test('should call notify sendEmail with the correct data - multiple grounds, ground a barred, no other info, one other appeal with grounds', async () => {
		const notifySendData = {
			doNotMockNotifySend: true,
			templateName: 'appeal-confirmed-enforcement-appellant',
			notifyClient: {
			...
			personalisation: {
				...
				appeal_grounds: ['b', 'c'],
				ground_a_barred: true,
				other_appeals_grounds_group: [{ reference: '100001', grounds: ['b'] }],
				other_info: 'No'
			}
		};
	...
	test('should call notify sendEmail with the correct data - multiple grounds, ground a barred, no other info, multiple other appeals with grounds', async () => {
		const notifySendData = {
			doNotMockNotifySend: true,
			templateName: 'appeal-confirmed-enforcement-appellant',
			notifyClient: {
