...
describe('appellant-case', () => {
	...
	describe('GET /appellant-case', () => {
		...
		it('should render the appellant case page with the expected content (Planning appeal / S78)', async () => {
			nock('http://test/').get('/appeals/2').reply(200, appealDataS78Planning);
			nock('http://test/')
			...
			expect(unprettifiedElement.innerHTML).toContain('Appellant case</h1>');
			expect(unprettifiedElement.innerHTML).toContain('Original plans or drawings</dt>');
		});
