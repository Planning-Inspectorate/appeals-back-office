 ...
 * @param {*} inspectorDecision
 * @returns {*|string|string}
 */
export function issueDecisionBackUrl(currentAppeal, childAppealId, inspectorDecision) {
	...
	if (isNaN(linkedAppealIndex)) {
		// Use the backUrl from the session inspectorDecision if it exists to return to the previous page prior to the issue decision flow
		const backUrl = inspectorDecision.backUrl;
		delete inspectorDecision.backUrl;
		return backUrl;
	}
