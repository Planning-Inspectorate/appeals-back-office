...
export const getDocumentUpload = async (request, response) => {
	...
	const uploadPageHeadingText = `Upload hearing document`;
	const documentTitle = `hearing document`;
	...
	await renderDocumentUpload({
		...
		nextPageUrl: `/appeals-service/appeal-details/${currentAppeal.appealId}/hearing-documents/add-document-details/${currentFolder.folderId}`,
...
export const getDocumentVersionUpload = async (request, response) => {
	...
	const [pageHeading, uploadContainerHeading] = (() => {
		const headingText = `Hearing documents`;
	...
	await renderDocumentUpload({
		...
		response,
		appealDetails: currentAppeal,
		backButtonUrl: `/appeals-service/appeal-details/${currentAppeal.appealId}/hearing-documents/manage-documents/${currentFolder.folderId}/${documentId}`,
		nextPageUrl: `/appeals-service/appeal-details/${currentAppeal.appealId}/hearing-documents/add-document-details/${currentFolder.folderId}/${documentId}`,
...
export const getAddDocumentDetails = async (request, response) => {
	...
	const categoryLabel = `Hearing document`;
	...
	await renderDocumentDetails({
		request,
		response,
		backLinkUrl: `/appeals-service/appeal-details/${currentAppeal.appealId}/hearing-documents/upload-documents/${currentFolder?.folderId}${documentIdFragment}`,
...
export const postAddDocumentDetails = async (request, response) => {
	...
	let categoryLabel = `Hearing document`;
	...
	await postDocumentDetails({
		request,
		response,
		backLinkUrl: `/appeals-service/appeal-details/${currentAppeal.appealId}/hearing-documents/upload-documents/${currentFolder?.folderId}`,
		nextPageUrl: `/appeals-service/appeal-details/${currentAppeal.appealId}/hearing-documents/check-your-answers/${currentFolder?.folderId}${documentIdFragment}`,
		pageHeadingTextOverride: categoryLabel
	});
};
...
export const getAddDocumentsCheckAndConfirm = async (request, response) => {
	...
	}/hearing-documents/add-document-details/${currentFolder.folderId}${
	...
	await renderUploadDocumentsCheckAndConfirm({
		...
		}/hearing-documents/upload-documents/${currentFolder.folderId}${
			documentId ? `/${documentId}` : ''
		}`,
...
export const postAddDocumentsCheckAndConfirm = async (request, response) => {
	...
	try {
		...
		logger.error(
			error,
			error instanceof Error ? error.message : 'Something went wrong when adding hearing document'
		);
	...
	try {
		...
		logger.error(
			...
			error instanceof Error
				? error.message
				: 'Something went wrong when adding hearing document version'
		);
...
export const getManageFolder = async (request, response) => {
	...
	const categoryLabel = `Hearing documents`;

	await renderManageFolder({
		request,
		response,
		backLinkUrl: `/appeals-service/appeal-details/${request.params.appealId}`,
		viewAndEditUrl: `/appeals-service/appeal-details/${request.params.appealId}/hearing-documents/manage-documents/${currentFolder.folderId}/{{documentId}}`,
		addButtonUrl: `/appeals-service/appeal-details/${request.params.appealId}/hearing-documents/upload-documents/${currentFolder.folderId}`,
		pageHeadingTextOverride: categoryLabel,
		canShare: true,
		shareAllLinkUrl: `/appeals-service/appeal-details/${request.params.appealId}/hearing-documents/manage-documents/${currentFolder.folderId}/share-all`
	});
};
...
/** @type {import('@pins/express').RequestHandler<Response>} */
export const getDeleteHearingDocument = async (request, response) => {
	...
	await renderDeleteDocument({
		request,
		response,
		backButtonUrl: `/appeals-service/appeal-details/${request.params.appealId}/hearing-documents/manage-documents/${currentFolder.folderId}/{{documentId}}`
	});
};

/** @type {import('@pins/express').RequestHandler<Response>} */
export const postDeleteHearingDocument = async (request, response) => {
	const { currentAppeal, currentFolder } = request;
	...
	await postDeleteDocument({
		...
		cancelUrl: `/appeals-service/appeal-details/${request.params.appealId}/hearing-documents/manage-documents/{{folderId}}/{{documentId}}`,
		uploadNewDocumentUrl: `/appeals-service/appeal-details/${currentAppeal.appealId}/hearing-documents/upload-documents/{{folderId}}`
	});
};
...
export const getShareDocumentCheckAndConfirm = async (request, response) => {
	...
	let notifyTemplateName = 'document-received.content.md';
	...
	const notifyPreview = await generateNotifyPreview(request.apiClient, notifyTemplateName, {
		...
		document_type: 'hearing-documents'
	});
