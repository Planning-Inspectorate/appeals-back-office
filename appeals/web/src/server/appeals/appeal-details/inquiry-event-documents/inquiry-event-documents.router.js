...
import { validateInviteResponses } from './inquiry-event-documents.validator.js';
...
router
	...
	.get(
		validateCaseDocumentId,
		assertUserHasPermission(permissionNames.updateCase),
		asyncHandler(controller.getDeleteInquiryEventDocument)
	)
	.post(
		validateCaseDocumentId,
		assertUserHasPermission(permissionNames.updateCase),
		documentsValidators.validateDocumentDeleteAnswer,
		asyncHandler(controller.postDeleteInquiryEventDocument)
	);
