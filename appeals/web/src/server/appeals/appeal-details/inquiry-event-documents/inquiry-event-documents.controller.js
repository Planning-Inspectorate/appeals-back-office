...
} from './inquiry-event-documents.mapper.js';
...
export const getInviteResponses = async (request, response) => {
	...
	const backLinkUrl = `/appeals-service/appeal-details/${appealId}/inquiry-event-documents/manage-documents/${folderId}/${documentId}`;
...
export const postInviteResponses = async (request, response) => {
	...
	return response.redirect(
		`/appeals-service/appeal-details/${appealId}/inquiry-event-documents/manage-documents/${folderId}/${documentId}/check-your-answers`
	);
};
...
export const getShareDocumentCheckAndConfirm = async (request, response) => {
	...
	const backLinkUrl = `/appeals-service/appeal-details/${appealId}/inquiry-event-documents/manage-documents/${folderId}/${documentId}/invite-responses`;
