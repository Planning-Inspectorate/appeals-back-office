...
import { getIdText, getTimetableTypes } from './change-appeal-timetable.mapper.js';
...
export const selectTimetableValidators = (req) => {
	...
	let timetableTypes = getTimetableTypes(
		currentAppeal,
		appellantCase,
	...
	changeProcedureTypeSession.appealTimetable = changeProcedureTypeSession.appealTimetable || {};
	...
	timetableTypes.forEach((timetableType) => {
		...
		session.changeProcedureType.appealTimetable[timetableType] = sessionDate;
	});
