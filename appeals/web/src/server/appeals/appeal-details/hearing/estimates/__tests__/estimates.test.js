	...
	return () => {
		it('should return 400 when field is empty', async () => {
			const response = await request
				.post(`${baseUrl}/2/hearing/estimates/add/timings`)
...
describe('add estimates', () => {
	...
	describe('GET /hearing/estimates/add', () => {
		// eslint-disable-next-line jest/expect-expect
		it('should redirect to /hearing/estimates/add/timings', () => {
			return new Promise((resolve) => {
				request
					.get(`${baseUrl}/2/hearing/estimates/add`)
					.expect(302)
					.expect('Location', `${baseUrl}/2/hearing/estimates/add/timings`)
					.end(resolve);
			});
		});
	});

	describe('GET /hearing/estimates/add/timings', () => {
		const appealId = 2;
		...
		beforeAll(async () => {
			...
			const response = await request.get(`${baseUrl}/${appealId}/hearing/estimates/add/timings`);
		...
		it('should render any saved response', async () => {
			...
			await request.post(`${baseUrl}/${appealId}/hearing/estimates/add/timings`).send({
				preparationTime: '2',
				sittingTime: '3',
				reportingTime: '1'
			});
	...
	describe('POST /hearing/estimates/add/timings', () => {
		const appealId = 2;
		...
		it('should redirect to /hearing/estimates/add/check-details with valid inputs', async () => {
			const response = await request
				.post(`${baseUrl}/${appealId}/hearing/estimates/add/timings`)
				.send({
					preparationTime: '2',
					sittingTime: '3',
					reportingTime: '1'
			...
			expect(response.headers.location).toBe(
				`${baseUrl}/${appealId}/hearing/estimates/add/check-details`
			);
		});
	...
	describe('GET /hearing/estimates/add/check-details', () => {
		const appealId = 1;
		const estimates = {
			preparationTime: '1.5',
			sittingTime: '2.0',
		...
		it('should render the correct heading', () => {
			expect(pageHtml.querySelector('h1')?.innerHTML.trim()).toBe(
				'Check details and add hearing estimates'
			);
		});

		it('should render the correct button text', () => {
			expect(pageHtml.querySelector('button')?.innerHTML.trim()).toBe('Add hearing estimates');
		});
	});

	describe('POST /hearing/estimates/add/check-details', () => {
		const appealId = 1;
		const estimates = {
			preparationTime: '1.5',
			sittingTime: '2.0',
		...
		it('should redirect to hearing page after successful submission', async () => {
			nock('http://test/')
...
describe('change estimates', () => {
	...
	describe('GET /hearing/estimates/change', () => {
		// eslint-disable-next-line jest/expect-expect
		it('should redirect to /hearing/estimates/change/timings', () => {
			return new Promise((resolve) => {
				request
					.get(`${baseUrl}/2/hearing/estimates/change`)
					.expect(302)
					.expect('Location', `${baseUrl}/2/hearing/estimates/change/timings`)
					.end(resolve);
			});
		});
	});

	describe('GET /hearing/estimates/change/timings', () => {
		const appealId = 2;
		...
		beforeAll(async () => {
			...
			const response = await request.get(`${baseUrl}/${appealId}/hearing/estimates/change/timings`);
			pageHtml = parseHtml(response.text);
		});
		...
		it('should render any saved response', async () => {
			...
			//set session data with post request
			await request.post(`${baseUrl}/${appealId}/hearing/estimates/change/timings`).send({
				preparationTime: '2',
				sittingTime: '3',
				reportingTime: '1'
			});
	...
	describe('POST /hearing/estimates/change/timings', () => {
		const appealId = 2;
		...
		it('should redirect to /hearing/estimates/change/check-details with valid inputs', async () => {
			const response = await request
				.post(`${baseUrl}/${appealId}/hearing/estimates/change/timings`)
				.send({
					preparationTime: '2',
					sittingTime: '3',
					reportingTime: '1'
			...
			expect(response.statusCode).toBe(302);
			expect(response.headers.location).toBe(
				`${baseUrl}/${appealId}/hearing/estimates/change/check-details`
			);
		});
	...
	describe('GET /hearing/estimates/change/check-details', () => {
		const appealId = 1;
		const estimates = {
			preparationTime: '1.5',
			sittingTime: '2.0',
	...
	describe('POST /hearing/estimates/change/check-details', () => {
		const appealId = 1;
		const estimates = {
			preparationTime: '1.5',
			sittingTime: '2.0',
