				...
				rows: [
					{
						...
						actions: {
							items: [
								{
									href: `/appeals-service/appeal-details/${currentAppeal.appealId}/site-visit-v2/schedule-visit`,
									text: 'Change',
					...
					},
					{
						...
						actions: {
							items: [
								{
									href: `/appeals-service/appeal-details/${currentAppeal.appealId}/site-visit-v2/schedule`,
									text: 'Change',
						...
						...(hasVisitDate
							? {
									...
									actions: {
										items: [
											{
												href: `/appeals-service/appeal-details/${currentAppeal.appealId}/site-visit-v2/schedule/schedule-visit-date`,
												text: 'Change',
												visuallyHiddenText: 'Do you know the date and time of the site visit?'
											}
										]
