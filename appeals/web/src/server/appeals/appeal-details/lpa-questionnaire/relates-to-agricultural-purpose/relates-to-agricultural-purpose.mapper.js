 ...
 * @returns {PageContent}
 */
export const relatesToAgriculturalPurposePage = (
	appealData,
	...
	const currentRadioValue =
		storedSessionData?.radio ?? lpaQuestionnaireData.relatesToBuildingWithAgriculturalPurpose;
	...
	const pageContent = {
		...
		pageComponents: [
			yesNoInput({
				name: 'relatesToAgriculturalPurposeRadio',
				value: currentRadioValue,
				legendText: `Is the building on agricultural land and will it be used for agricultural purposes?`,
