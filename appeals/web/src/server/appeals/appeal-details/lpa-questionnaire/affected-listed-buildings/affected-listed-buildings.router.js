...
import * as controllers from './affected-listed-buildings.controller';
import * as validators from './affected-listed-building.validator';
...
router
	...
	.post(validators.validateAffectedListedBuilding, asyncHandler(controllers.postAddAffectedListedBuilding));
...
router
	...
	.post(validators.validatedAffectedListedBuilding, asyncHandler(controllers.postChangeAffectedListedBuilding));
