...
export function allocationCheckPage(appealDetails, flowRoute, sessionData) {
	const backLinkUrl = `/appeals-service/appeal-details/${appealDetails.appealId}/lpa-statement${
...
export function allocationSpecialismsPage(appealDetails, specialisms, sessionData, flowRoute) {
	const backLinkUrl = `/appeals-service/appeal-details/${appealDetails.appealId}/lpa-statement/${flowRoute}/allocation-level`;
