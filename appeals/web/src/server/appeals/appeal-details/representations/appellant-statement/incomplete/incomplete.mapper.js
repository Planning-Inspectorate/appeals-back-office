 ...
 * @returns {PageContent}
 */
export function rejectAppellantStatementPage(appealDetails) {
...
export function setNewDatePage(appealDetails, deadlineString) {
	/** @type {PageContent} */
	const pageContent = {
		backLinkUrl: `/appeals-service/appeal-details/${appealDetails.appealId}/appellant-statement/incomplete/reasons`,
		...
		pageComponents: [
			yesNoInput({
				name: 'setNewDate',
				legendText: 'Do you want to allow the appellant to resubmit their statement?',
