		...
		.map((action) => {
			switch (action) {
				...
				case 'progressFromFinalComments': {
					return `<a class="govuk-link" href="/appeals-service/appeal-details/${appealId}/share">Progress case</a>`;
				}
				...
				case 'reviewIpComments': {
					return `<a class="govuk-link" href="/appeals-service/appeal-details/${appealId}/interested-party-comments">Review IP comments<span class="govuk-visually-hidden"> for appeal ${appealId}</span></a>`;
				}
				...
				case 'shareFinalComments': {
					return `<a class="govuk-link" href="/appeals-service/appeal-details/${appealId}/share">Share final comments</a>`;
				}
				case 'shareIpCommentsAndLpaStatement': {
					return `<a class="govuk-link" href="/appeals-service/appeal-details/${appealId}/share">Share IP comments and LPA statement<span class="govuk-visually-hidden"> for appeal ${appealId}</span></a>`;
				}
				case 'startAppeal': {
					return isCaseOfficer
