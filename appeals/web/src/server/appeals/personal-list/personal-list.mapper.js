...
/** @typedef {Partial<AppealSummary & { appealTimetable: Record<string,string>, awaitingLinkedAppeal: boolean, costsSummary?: CostsSummary}>} PersonalListAppeal */
...
export function mapActionLinksForAppeal(appeal, isCaseOfficer, request) {
	if (appeal.appealId === 122) {
		console.log('appealId', appeal.appealId);
	}
