	...
	describe('GET /', () => {
		it('should render national list - no pagination', async () => {
			...
			expect(unprettifiedElement.innerHTML).toContain(
				'Enter the appeal reference, planning application or enforcement reference, or postcode (including spaces)</label>'
			);
		...
		it('should render correct appeal procedure dropdown in filters', async () => {
			...
			expect(unprettifiedElement.innerHTML).toContain('Written representations');
		});
		...
		it('should show enforcement reference instead of planning application reference if appeal type is enforcement listed building', async () => {
			nock('http://test/')
				.get('/appeals?pageNumber=1&pageSize=30')
				.reply(200, {
					itemCount: 1,
