...
export const notificationBannerDefinitions = {
	...
	appealUnlinked: {
		type: 'success',
		pages: ['appealDetails', 'manageLinkedAppeals', 'appellantCase', 'lpaQuestionnaire'],
		text: 'Appeals unlinked'
	},
	leadAppealChanged: {
		type: 'success',
		pages: ['appealDetails', 'manageLinkedAppeals', 'appellantCase', 'lpaQuestionnaire'],
		text: 'Lead appeal updated'
	},
	relatedAppeal: {
		type: 'success',
...
const appealActionRequiredToNotificationBannerMapping = {
	...
	enforcementNoticeAppealIncomplete: 'enforcementNoticeAppealIncomplete'
};
