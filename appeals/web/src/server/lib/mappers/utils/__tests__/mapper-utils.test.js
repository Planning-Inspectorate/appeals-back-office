...
describe('required actions', () => {
	describe('getRequiredActionsForAppeal', () => {
		...
		describe('when appeal status is "VALIDATION"', () => {
			...
			it('should return "reviewAppellantCase" if the appellant case due date has not passed, and the appellant case has been received', () => {
				expect(
					getRequiredActionsForAppeal({
						...appealDataWithValidationStatus,
						documentationSummary: {
		...
		describe('when appeal status is "LPA_QUESTIONNAIRE"', () => {
			...
			it('should return "awaitingLpaQuestionnaire" if the lpa questionnaire has not been received', () => {
				expect(
					getRequiredActionsForAppeal({
			...
			it('should return "lpaQuestionnaireOverdue" if the lpa questionnaire has been received, and the lpa questionnaire due date has passed', () => {
				expect(
					getRequiredActionsForAppeal({
						...appealDataWithLPAQuestionnaireStatus,
						documentationSummary: {
			...
			it('should return "awaitingLpaUpdate" if the lpa questionnaire has been received, and the lpa questionnaire due date has not passed, and the lpa questionnaire is marked as incomplete', () => {
				expect(
					getRequiredActionsForAppeal({
						...appealDataWithLPAQuestionnaireStatus,
						documentationSummary: {
			...
			it('should return "reviewLpaQuestionnaire" if the lpa questionnaire has been received, and the lpa questionnaire due date has not passed, and the lpa questionnaire is not marked as incomplete', () => {
				expect(
					getRequiredActionsForAppeal({
						...appealDataWithLPAQuestionnaireStatus,
						documentationSummary: {
