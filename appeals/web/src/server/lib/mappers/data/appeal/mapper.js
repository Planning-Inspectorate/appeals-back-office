 ...
 * @returns {Promise<SubMapperParams>}
 */
const getSubmapperParams = async ({
	appealDetails,
	session,
	currentRoute,
	...
	return {
		...
		currentRoute,
		session,
		skipAssignedUsersData: !!skipAssignedUsersData,
...
export const initialiseAndMapAppealData = initialiseAndMapDataFactory(
	getSubmapperParams,
	submaps,
	getAppealType,
	'appeal'
