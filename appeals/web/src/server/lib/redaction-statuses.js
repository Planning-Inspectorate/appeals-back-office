...
export function redactionStatusNameToId (redactionStatuses, name) {
	return redactionStatuses.find((redactionStatus) => redactionStatus.name.toLowerCase() === name.toLowerCase())?.id;
}
...
export function redactionStatusIdToName (redactionStatuses, id) {
	return redactionStatuses.find((redactionStatus) => redactionStatus.id === id)?.name?.toLowerCase();
}
