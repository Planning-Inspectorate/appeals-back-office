 ...
 * @returns {string}
 */
export function getNextStateDisplayTextOnStatementsComplete(appealType, procedureType, isHearingSetUp){
	...
	return mapStatusFilterLabel(mapStatusText(eventualState, appealType, procedureType)).toLowerCase();
}
