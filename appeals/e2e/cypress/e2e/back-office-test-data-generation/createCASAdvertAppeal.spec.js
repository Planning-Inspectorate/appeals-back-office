...
describe('Create CAS advert application', () => {
	it('Create CAS advert appeal according to specified values ', () => {
		cy.login(users.appeals.caseAdmin);

		cy.createCase({ ...appealsApiRequests.casAdvertsSubmission.casedata }).then((refObj) => {
			caseObj = refObj;
			appeal = caseObj;
