...
describe('Create CAS planning application', () => {
	it('Create CAS planning appeal according to specified values ', () => {
		cy.login(users.appeals.caseAdmin);

		cy.createCase({ caseType: 'ZP' }).then((refObj) => {
			caseObj = refObj;
			appeal = caseObj;
