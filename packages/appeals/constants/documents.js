...
export const DOCTYPE = {
	...
	WHO_NOTIFIED_SITE_NOTICE: 'siteNotice',
	WHO_NOTIFIED_LETTERS_TO_NEIGHBOURS: 'lettersToNeighbours',
	WHO_NOTIFIED_PRESS_ADVERT: 'pressAdvert',
...
export const FOLDERS = [
	...
	`${STAGE.LPA_QUESTIONNAIRE}/${DOCTYPE.WHO_NOTIFIED_SITE_NOTICE}`,
	`${STAGE.LPA_QUESTIONNAIRE}/${DOCTYPE.WHO_NOTIFIED_LETTERS_TO_NEIGHBOURS}`,
	`${STAGE.LPA_QUESTIONNAIRE}/${DOCTYPE.WHO_NOTIFIED_PRESS_ADVERT}`,
