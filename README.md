...
1. Identify the latest tagged release name in the data-model repo - eg "draft-07" from here:
...
```shell
npm uninstall pins-data-model && npm prune && npm install github:Planning-Inspectorate/data-model#draft-07
```
